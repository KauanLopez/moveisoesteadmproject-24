...
import { Image, Pencil, Trash2, ListFilter } from 'lucide-react';
...
interface CatalogTableProps {
  ...
  onManageItems: (catalog: CatalogWithCategory) => void;
}
            ...
            <TableRow key={catalog.id}>
              ...
              <TableCell className="text-right">
                <div className="flex justify-end gap-2">
                  <Button variant="outline" size="sm" onClick={() => onManageItems(catalog)} title="Gerenciar Itens">
                    <ListFilter size={16} />
                  </Button>
                  <Button variant="outline" size="sm" onClick={() => onEdit(catalog)} title="Editar">
                    <Pencil size={16} />
                  </Button>
                  <Button variant="destructive" size="sm" onClick={() => onDelete(catalog.id)} title="Excluir">
                    <Trash2 size={16} />
                  </Button>
                </div>
              </TableCell>
